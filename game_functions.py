...
def check_events(si_settings, screen, stats, sb, play_button, ship, aliens,
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(si_settings, screen, stats, sb,
                              play_button, ship,aliens, bullets,
                              mouse_x, mouse_y)


def check_play_button(si_settings, screen, stats, sb, play_button,
...
def create_fleet(si_settings, screen, ship, aliens):
    ...
    number_rows = get_number_rows(si_settings, ship.rect.height,
                                  alien.rect.height)
...
def update_screen(si_settings, screen, stats, sb, ship, aliens, bullets,
                  play_button):
    screen.blit(si_settings.background_image, (0, 0))
